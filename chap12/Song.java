...
public class Song {
  ...
  public String toString() {
    return this.title + " (" + this.genre + ") - " + this.artist + " [" + this.year + "]";
  }
...
class JukeboxStreams {
  public static void main(String[] args) {
    ...
    System.out.println("All Rock:");
    System.out.println(rockSongs + "\n");

    List<String> genreList = songList.stream().map(Song::getGenre).distinct().collect(Collectors.toList());
    System.out.println("All Genre:");
    System.out.println(genreList + "\n");

    List<Song> yearSorted = songList.stream().sorted(Comparator.comparingInt(Song::getYear).reversed()).limit(10).collect(Collectors.toList());
    System.out.println("Year sorted:");
    System.out.println(yearSorted + "\n");
  }
}